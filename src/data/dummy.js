...
export const EditorData = () => (
  <div>
    <h3>
      ...
      Online Playgrounds
      If you are interested in playing around with React, you can use an online code playground. Try a Hello World template on CodePen, CodeSandbox, or Stackblitz.
...
export const chatData = [
  {
    image:
      avatar2,
    message: 'Ishika Joined the Team!',
  ...
  },
  {
    image:
      avatar,
    message: 'Vaibia completed tasks',
...
export const productsPerformance = [
  {
    image:
      macbooka,
    title: 'finest laptop from apple',
    desc: '8gb ram/512gb ssd m1pro chip',
    rating: 'Good',
    itemSold: '65%',
    earningAmount: '$556,000',
  },
  {
    image:
      hpsp,
    title: 'Premium touch laptop from hp ',
    desc: '12gb/1tb ssd, i9 12th gen proc. , 15-touch points support, touch pen including',
    rating: 'Excellent',
    itemSold: '88%',
  ...
  },
  {
    image:
      macbookp,
    title: 'The Pro machine from apple',
    desc: '6gb/1tb ssd , m2 pro chip, touch bar, 16" inch ',
    rating: 'amazing',
    itemSold: '76%',
    earningAmount: '$1,281,000',
  },
  {
    image:
      hp1,
    title: 'lighest touch laptop from HP',
    desc: '8gb/512 ssd , 10 touch points , 13" inch oled display , including hp pen',
    rating: 'Poor',
    itemSold: '23%',
...
export const ordersData = [
  ...
  },
  {
    ...
    CustomerName: 'Danai',
    TotalAmount: 1024.99,
    OrderItems: 'Microsoft Surface GO',
    Location: 'Delhi',
    Status: 'canceled',
    StatusBg: '#FF5C8E',
    ProductImage: micgo,
